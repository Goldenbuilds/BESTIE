...
__all__ = [
    'SPSMF_SAPI_PROPERTIES', 'eLEXTYPE_RESERVED9', 'SVP_15',
    'DISPID_SPARecoResult', 'eLEXTYPE_PRIVATE3', 'DISPID_SLWType',
    'SPAS_RUN', 'ISpeechVoice', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPIDSPTSI_SelectionOffset', 'eLEXTYPE_VENDORLEXICON',
    'SFTInput', 'SPPHRASEREPLACEMENT', 'ISpEventSink',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SGRSTRule', 'SPFM_OPEN_READONLY', 'ISpeechLexiconWord',
    'DISPID_SPPValue', 'DISPID_SRCEEndStream', 'SPWT_LEXICAL',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SLWs_NewEnum',
    'SREPropertyStringChange', 'SAFT11kHz8BitStereo',
    'DISPID_SpeechPhoneConverter', 'DISPID_SRCEBookmark',
    'SpeechCategoryRecognizers', 'ISpeechPhraseProperties',
    ...
    'SSTTDictation', 'DISPID_SpeechBaseStream', 'SGLexical',
    'DISPID_SPIReplacements', 'SREPhraseStart', 'SFTSREngine',
    'SVP_4', 'DISPID_SGRSTWeight', 'SPSHORTCUTPAIRLIST',
    'eLEXTYPE_LETTERTOSOUND', 'SAFT24kHz16BitMono',
    'SpeechTokenKeyFiles', 'DISPID_SRSAudioStatus',
    ...
    'DISPID_SPEActualConfidence', 'SVF_Stressed',
    'DISPID_SpeechLexiconProns', 'DISPID_SOTRemoveStorageFileName',
    'SDTReplacement', 'DISPID_SPEAudioTimeOffset', 'SVP_8',
    'DISPID_SPRuleId', 'SVP_12', 'SpeechBookmarkOptions',
    'DISPID_SGRsItem', 'DISPID_SGRSRule', 'SpUnCompressedLexicon',
    'ISpeechPhraseAlternate', 'SpeechGrammarWordType', 'SINone',
    'UINT_PTR', 'DISPID_SpeechVoiceStatus', 'SpCompressedLexicon',
    'DISPID_SOTGetDescription', 'SpSharedRecognizer', 'eLEXTYPE_USER',
    'DISPID_SPAsCount', 'DISPID_SOTsCount', 'DISPID_SPRText',
    'DISPID_SRCEPropertyNumberChange', 'SPINTERFERENCE_TOOFAST',
    'SPBO_PAUSE', 'DISPID_SDKDeleteValue', 'DISPID_SVEBookmark',
    'DISPID_SWFEBitsPerSample', 'DISPID_SVEStreamStart',
    'DISPID_SVEWord', 'SpeechRecoProfileProperties', 'SVSFlagsAsync',
    'SpeechRecognitionType', 'tagSTATSTG', 'SPSFunction',
    'SPVPRI_ALERT', 'SpeechAudioProperties', 'SP_VISEME_0',
    'DISPID_SABufferInfo', 'DISPID_SAEventHandle',
    'SAFT12kHz16BitMono', 'ISpeechPhraseInfo', 'SASRun',
    'ISpResourceManager', 'SGDSActiveWithAutoPause', 'SVEAllEvents',
    'SVP_9', 'SPPHRASE', 'DISPID_SPIProperties', 'eLEXTYPE_PRIVATE5',
    'SP_VISEME_3', 'DISPID_SPISaveToMemory', 'DISPID_SLWLangId',
    'SECFIgnoreCase', 'DISPID_SOTs_NewEnum',
    'DISPID_SpeechFileStream', 'SVP_6', 'SGSEnabled',
    'DISPID_SRGDictationSetState', 'DISPID_SWFEBlockAlign',
    'SpeechPropertyResponseSpeed', 'SpWaveFormatEx',
    'DISPID_SRAudioInputStream', 'DISPID_SFSOpen',
    'DISPID_SPRDisplayAttributes', 'DISPID_SRGetPropertyNumber',
    'SpSharedRecoContext', 'SPEI_PROPERTY_NUM_CHANGE', 'SP_VISEME_20',
    'STSF_AppData', 'SRADynamic', 'DISPID_SGRsFindRule',
    'DISPID_SRRDiscardResultInfo', 'SAFTGSM610_8kHzMono',
    'DISPID_SGRAddResource', 'SPEI_RECO_STATE_CHANGE', 'SVPNormal',
    'SDTAlternates', 'DISPID_SPPName', 'ISpRecognizer',
    'SAFTADPCM_8kHzMono', 'SP_VISEME_13', 'DISPID_SLAddPronunciation',
    'SAFT16kHz16BitMono', 'DISPID_SMSADeviceId', 'DISPID_SPPsCount',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPEI_RECO_OTHER_CONTEXT', 'SpeechRetainedAudioOptions',
    'DISPID_SDKEnumValues', 'SDA_One_Trailing_Space',
    'STSF_FlagCreate', 'DISPID_SVGetAudioInputs',
    'DISPID_SpeechObjectToken', 'ISpeechLexiconPronunciations',
    'ISpVoice', 'DISPID_SpeechPhraseBuilder', 'SpMMAudioEnum',
    'DISPID_SPIEngineId', 'SVPOver', 'SAFTText',
    'DISPID_SpeechRecognizerStatus', 'SpeechRecoContextState',
    'DISPID_SREmulateRecognition', 'ISpeechBaseStream',
    'DISPID_SPILanguageId', 'ISpeechPhraseProperty',
    'DISPID_SPRulesCount', 'SpeechGrammarState',
    'SGDSActiveUserDelimited', 'DISPID_SRRPhraseInfo',
    'SPEI_SR_PRIVATE', 'DISPID_SDKGetBinaryValue',
    'DISPID_SVEventInterests', 'SPBO_NONE', 'SDKLLocalMachine',
    'DISPID_SVVoice', 'STSF_CommonAppData', 'SPDKL_CurrentUser',
    'DISPID_SRCRecognizer', 'DISPID_SDKOpenKey',
    'DISPID_SOTDisplayUI', 'SP_VISEME_4', 'DISPID_SFSClose',
    'eWORDTYPE_ADDED', 'SPDKL_LocalMachine',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SPEAudioSizeTime',
    'SPEI_WORD_BOUNDARY', 'eLEXTYPE_RESERVED7', 'SGRSTTDictation',
    'SPEI_RESERVED1', 'SWPUnknownWordUnpronounceable',
    'DISPID_SOTCSetId', 'DISPID_SVResume', 'SAFT12kHz16BitStereo',
    ...
    'DISPID_SRRSaveToMemory', 'DISPID_SVRate', 'SpStream',
    'DISPID_SVSCurrentStreamNumber', 'SVP_7',
    'SpeechDisplayAttributes', 'ISpeechRecoResultDispatch',
    'STCInprocServer', 'SAFT44kHz16BitMono', 'SPRST_NUM_STATES',
    'eLEXTYPE_USER_SHORTCUT', 'SPRECOGNIZERSTATUS',
    'DISPID_SPIElements', 'SWPUnknownWordPronounceable',
    'SpeechRuleAttributes', 'SVSFIsFilename',
    'SpeechDictationTopicSpelling', 'ISpeechPhoneConverter',
    'DISPID_SRDisplayUI', 'DISPID_SBSFormat',
    'ISpPhoneticAlphabetConverter', 'DISPID_SRCESoundEnd',
    'SAFTADPCM_22kHzStereo', 'ISpeechRecoResultTimes',
    'ISpeechObjectTokenCategory', 'SAFTADPCM_11kHzStereo',
    ...
    'DISPID_SRSetPropertyNumber', 'DISPID_SLWsCount', 'SPSLMA',
    'SpeechAllElements', 'SpeechVisemeType', 'SAFT22kHz8BitMono',
    'ISpeechGrammarRules', 'SRCS_Enabled', 'SVP_0',
    'SVSFNLPSpeakPunc', 'SpeechRegistryUserRoot',
    'DISPID_SPAStartElementInResult', 'SVEEndInputStream',
    'SAFT24kHz8BitStereo', 'SDTRule', 'SAFTCCITT_uLaw_8kHzStereo',
    'SDTProperty', 'DISPID_SVPause', 'SVSFParseSsml',
    'DISPID_SLPType', 'DISPID_SPEs_NewEnum', 'SPEI_PHRASE_START',
    'DISPID_SRIsUISupported', 'SRSActiveAlways',
    'SSSPTRelativeToStart', 'SLTUser', 'SPSERIALIZEDPHRASE',
    'ISpeechAudioFormat', 'SAFTGSM610_22kHzMono',
    'DISPID_SRRSpeakAudio', 'STCLocalServer', 'DISPID_SGRClear',
    'DISPID_SRCCreateResultFromMemory', 'SPAUDIOSTATE',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SRCEventInterests',
    'DISPID_SLPPhoneIds', 'SPINTERFERENCE', 'SPPHRASEPROPERTY',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SMSGetData',
    'SPSMF_UPS', 'DISPID_SGRAttributes', 'SPAR_Unknown', 'IStream',
    'eWORDTYPE_DELETED', 'SAFT16kHz8BitMono',
    'DISPID_SpeechObjectTokens', 'DISPID_SVSpeakCompleteEvent',
    'SPPARTOFSPEECH', 'DISPID_SOTDataKey', 'DISPID_SPRs_NewEnum',
    'ISpeechPhraseElements', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SITooFast', 'SDTPronunciation', 'SRAInterpreter',
    'SPPS_Modifier', 'SPCT_SUB_DICTATION', 'ISpPhoneConverter',
    'SP_VISEME_14', 'SPSSuppressWord', 'SGDSInactive',
    '__MIDL_IWinTypes_0009', 'eLEXTYPE_PRIVATE19', 'LONG_PTR',
    'DISPID_SVGetProfiles', 'SPCONTEXTSTATE', 'SPEI_RESERVED2',
    'SECFEmulateResult', 'SPCS_ENABLED', 'DISPID_SCSBaseStream',
    'SPADAPTATIONRELEVANCE', 'SRTSMLTimeout', 'eLEXTYPE_PRIVATE13',
    'SP_VISEME_8', 'SPGS_EXCLUSIVE', 'SP_VISEME_11',
    'DISPID_SRGReset', 'SpTextSelectionInformation',
    'SAFT32kHz8BitStereo', 'SRAImport', 'DISPID_SpeechPhraseProperty',
    'SAFT48kHz16BitMono', 'ISpeechObjectToken',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SpeechPhraseAlternate',
    'ISpXMLRecoResult', 'SPPS_Verb', 'SAFT48kHz8BitMono',
    'ISpRecoGrammar2', 'DISPID_SGRsCount',
    'SpeechStreamSeekPositionType', 'DISPID_SDKGetlongValue',
    'SPAR_Low', 'SAFT32kHz8BitMono', 'SPRST_ACTIVE', 'SPCT_DICTATION',
    'SVP_10', 'SVSFIsNotXML', 'SPPS_Interjection', 'DISPID_SRGState',
    ...
    'DISPID_SPRules_NewEnum', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'ISpNotifySource', 'DISPID_SGRSTransitions',
    'ISpeechLexiconPronunciation', 'SpeechCategoryAudioOut',
    'SpeechGrammarTagWildcard', 'SPCT_SUB_COMMAND', 'DISPID_SRCPause',
    'SVSFPersistXML', 'DISPID_SPIEnginePrivateData',
    'DISPID_SRCRetainedAudio', 'SAFTCCITT_ALaw_44kHzMono',
    'ISpShortcut', 'DISPID_SRGCmdSetRuleIdState', 'SPEVENTSOURCEINFO',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'ISpeechGrammarRuleState',
    'DISPID_SOTCDefault', 'DISPID_SRCVoice', 'DISPID_SRCBookmark',
    'SECFNoSpecialChars', 'DISPID_SRGCmdLoadFromMemory',
    'SpInprocRecognizer', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SGRAddState', 'SPXRO_SML', 'DISPID_SRRRecoContext',
    'ISpPhrase', 'SPPS_LMA', 'DISPID_SpeechAudio',
    'eLEXTYPE_RESERVED8', 'DISPID_SADefaultFormat',
    'SPDATAKEYLOCATION', 'SVEPrivate', 'SPFM_NUM_MODES',
    'DISPID_SRGetFormat', 'DISPID_SpeechRecognizer',
    'DISPID_SPRuleParent', 'DISPID_SRCCreateGrammar',
    'ISpeechXMLRecoResult', 'DISPID_SPIRule', 'DISPID_SPPConfidence',
    'SPGS_DISABLED', 'SRSInactive', 'SVSFParseAutodetect',
    'ISpeechGrammarRuleStateTransitions', 'SP_VISEME_6',
    'DISPID_SVVolume', 'DISPID_SVGetVoices', 'DISPID_SVEStreamEnd',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPEI_UNDEFINED',
    'DISPID_SOTId', 'DISPID_SDKDeleteKey', 'eLEXTYPE_PRIVATE20',
    'SAFT8kHz8BitStereo', 'DISPID_SABIMinNotification',
    'SPWAVEFORMATTYPE', 'DISPID_SWFEFormatTag',
    'DISPID_SPEDisplayAttributes', 'SASPause', 'DISPID_SPRsCount',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SRRTLength',
    'SBOPause', 'SVEViseme', 'DISPID_SRIsShared',
    'DISPID_SpeechMemoryStream', 'SpeechRuleState', 'SPRS_INACTIVE',
    'ISpProperties', 'Speech_Default_Weight', 'SLOStatic',
    'SREPrivate', 'SPLOADOPTIONS', 'SREStreamStart',
    'SpeechAudioFormatGUIDWave', 'DISPID_SRGRules', 'DISPID_SGRName',
    'DISPID_SVStatus', 'SVSFParseMask',
    'DISPID_SGRSAddWordTransition', 'DISPID_SGRSTPropertyName',
    'ISpeechGrammarRule', 'DISPID_SLWWord', 'eLEXTYPE_MORPHOLOGY',
    'SBONone', 'SPINTERFERENCE_NONE', 'SPBO_TIME_UNITS',
    'DISPID_SGRSTPropertyId', 'DISPID_SGRsCommitAndSave',
    'DISPID_SPRuleFirstElement', 'ISpeechGrammarRuleStateTransition',
    'SPEI_INTERFERENCE', 'SVEBookmark', 'SRERecognition',
    'SGDSActive', 'DISPID_SpeechRecoResult', '_RemotableHandle',
    'SITooQuiet', 'SGRSTTEpsilon', 'SPEI_ADAPTATION',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SpeechPhraseRule', 'SPVPRI_NORMAL', 'SpResourceManager',
    'DISPID_SPRFirstElement', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SGRSTText', 'SPEI_PROPERTY_STRING_CHANGE',
    'SpeechLoadOption', 'eLEXTYPE_PRIVATE14', 'SDTDisplayText',
    'SREPropertyNumChange', 'SpeechRecoEvents', 'SDKLDefaultLocation',
    'SRSEIsSpeaking', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SRGCmdLoadFromObject', 'ISpeechFileStream',
    'DISPID_SDKSetBinaryValue', 'ISpRecoCategory',
    'SpStreamFormatConverter', 'ISpPhraseAlt', 'SpeechAudioVolume',
    'DISPID_SAFSetWaveFormatEx', 'DISPIDSPTSI_SelectionLength',
    'SpeechFormatType', 'SVP_14', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SVSFParseSapi', 'ISpGrammarBuilder', 'DISPID_SpeechAudioStatus',
    'DISPID_SpeechLexiconWord', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SPIRetainedSizeBytes', 'SP_VISEME_1', 'ISpSerializeState',
    'SPAS_CLOSED', 'ISpPhoneticAlphabetSelection',
    'SPWT_PRONUNCIATION', 'SpeechVoicePriority',
    'IInternetSecurityManager', 'DISPID_SASNonBlockingIO',
    'eLEXTYPE_PRIVATE10', 'SRESoundEnd', 'DISPID_SDKEnumKeys',
    'DISPID_SDKSetStringValue', 'SP_VISEME_7', 'ISpRecognizer3',
    'DISPID_SVSpeak', 'SSSPTRelativeToEnd',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SRCEInterference',
    'SPINTERFERENCE_NOISE', '_SPAUDIOSTATE', 'SpNullPhoneConverter',
    'SPEI_RESERVED3', 'DISPID_SPERequiredConfidence',
    'SpeechGrammarRuleStateTransitionType', 'SPEI_VISEME',
    'SECHighConfidence', 'DISPID_SASFreeBufferSpace',
    'SpeechEmulationCompareFlags', 'SpeechCategoryRecoProfiles',
    'SVSFUnusedFlags', 'DISPID_SRGCmdLoadFromFile', 'SpFileStream',
    'DISPID_SOTCreateInstance', 'SRADefaultToActive', 'ISpNotifySink',
    'SAFTADPCM_11kHzMono', 'SPSERIALIZEDRESULT', 'SPEI_REQUEST_UI',
    'DISPID_SpeechPhraseRules', 'DISPID_SRCEFalseRecognition',
    'SRAExport', 'SGRSTTRule', 'SPRST_INACTIVE',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SRRTTickCount',
    'SPPS_Function', 'SpeechAudioState', 'DISPID_SRCResume',
    'DISPID_SAFGuid', 'SPPS_SuppressWord', 'SpeechVisemeFeature',
    'SGDisplay', 'SGRSTTWildcard', 'SpLexicon',
    'SPINTERFERENCE_TOOQUIET',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SOTRemove',
    'ISpeechAudio', 'SpVoice', 'SAFT48kHz16BitStereo',
    'DISPID_SRCRequestedUIType', 'DISPID_SMSAMMHandle',
    'SVEStartInputStream', 'ISpeechRecoGrammar',
    'SAFTADPCM_44kHzStereo', 'ISpeechPhraseInfoBuilder',
    'SPPROPERTYINFO', 'SPEI_END_SR_STREAM', 'eLEXTYPE_PRIVATE7',
    'SAFT16kHz8BitStereo', 'ISpRecoContext2', 'ISpStream',
    'DISPID_SBSWrite', 'SPPS_RESERVED2', 'SpShortcut',
    'SPEI_TTS_AUDIO_LEVEL', 'SRATopLevel', 'SVP_18',
    'SAFT48kHz8BitStereo', 'DISPID_SVPriority', 'SPWORDTYPE',
    'SPSUnknown', 'DISPID_SPAs_NewEnum', 'SpInProcRecoContext',
    'SPEI_VOICE_CHANGE', 'DISPID_SRGDictationUnload', 'SPRULE',
    'DISPID_SPPFirstElement', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SRRAudio', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SPCPhoneToId', 'SpObjectTokenCategory', 'DISPID_SLPsItem',
    'DISPID_SASCurrentDevicePosition', 'ISpObjectWithToken',
    'DISPID_SMSSetData', 'SRTEmulated', 'SPAO_RETAIN_AUDIO',
    'DISPID_SVSLastBookmark', 'ISpDataKey', 'DISPID_SVSVisemeId',
    'SASClosed', 'SpeechTokenValueCLSID', 'SDTLexicalForm',
    'SPDKL_DefaultLocation', 'SVF_None', 'SpeechTokenContext',
    'SPSHT_EMAIL', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SpeechDataKey', 'SVP_21', 'DISPID_SRCreateRecoContext',
    'SAFT8kHz8BitMono', 'SPWT_DISPLAY', 'SPPS_Unknown',
    'SPFM_CREATE_ALWAYS', 'DISPID_SpeechRecoResult2', 'SPLEXICONTYPE',
    'SREHypothesis', 'SpMMAudioOut', 'DISPID_SPEsItem',
    'DISPID_SPPsItem', 'SpeechVoiceEvents',
    'DISPID_SVSInputSentencePosition', 'DISPID_SLGetPronunciations',
    'ISpStreamFormatConverter', 'DISPID_SGRSTsCount',
    'STSF_LocalAppData', 'DISPID_SRSSupportedLanguages',
    'SP_VISEME_12', 'ISpLexicon', 'DISPID_SRRAudioFormat',
    'DISPID_SOTCId', 'SVSFNLPMask', 'SpMemoryStream',
    'DISPID_SPPNumberOfElements', 'SPSNotOverriden', 'SPWORD',
    'ISpAudio', 'SPEI_SR_RETAINEDAUDIO', 'SAFTCCITT_uLaw_8kHzMono',
    'SPEI_MAX_SR', 'SGRSTTTextBuffer', 'DISPID_SRGRecoContext',
    'ISpObjectToken', 'SPSHT_OTHER', 'SPAR_High',
    'DISPID_SpeechCustomStream', 'DISPID_SGRSTNextState',
    'SpeechUserTraining', 'DISPID_SVGetAudioOutputs', 'DISPIDSPRG',
    'SP_VISEME_5', 'SAFT24kHz16BitStereo', 'eLEXTYPE_PRIVATE2',
    'eLEXTYPE_PRIVATE6', 'DISPID_SPPs_NewEnum', 'SPAS_PAUSE',
    'SP_VISEME_16', 'SREInterference', 'SAFTNoAssignedFormat',
    'SSFMOpenReadWrite', 'SPSNoun', 'DISPID_SRGDictationLoad',
    'SAFTCCITT_ALaw_11kHzMono', 'ISpeechAudioBufferInfo',
    'ISpeechLexicon', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SpeechLexiconPronunciation', 'SPFM_OPEN_READWRITE',
    'DISPID_SWFEChannels', 'ISpeechRecoContext',
    'DISPID_SRCSetAdaptationData', 'ISpeechMemoryStream',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SLPLangId',
    'SRAORetainAudio', 'SPEI_MIN_SR', 'STCRemoteServer',
    'SpPhoneticAlphabetConverter', 'DISPID_SVESentenceBoundary',
    'DISPID_SPIStartTime', 'SRTAutopause',
    'SSSPTRelativeToCurrentPosition', 'SRSEDone',
    'DISPID_SPRuleNumberOfElements', 'ISpObjectTokenCategory',
    'DISPID_SRRGetXMLResult', 'DISPID_SPPParent',
    'eLEXTYPE_PRIVATE18', 'DISPID_SRGId',
    'SpeechPropertyAdaptationOn', 'SREStateChange',
    'DISPID_SWFEExtraData', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SOTCategory', 'SRSActive', 'SPEI_RECOGNITION',
    'SPXMLRESULTOPTIONS', 'DISPID_SGRsCommit', 'DISPID_SPACommit',
    'SpMMAudioIn', 'SPWORDPRONOUNCEABLE', 'IEnumSpObjectTokens',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SRSetPropertyString',
    'DISPID_SAStatus', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SPAsItem', 'DISPID_SOTsItem', 'DISPID_SMSALineId',
    'SPAO_NONE', 'DISPID_SABIEventBias', 'SpeechVoiceSpeakFlags',
    'SpeechTokenShellFolder', 'DISPID_SOTCEnumerateTokens',
    'SAFT16kHz16BitStereo', 'SVSFVoiceMask', 'SRSInactiveWithPurge',
    'SAFTADPCM_22kHzMono', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SRAudioInput', 'DISPID_SABufferNotifySize', 'SVP_13',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SWFESamplesPerSec',
    'SAFTGSM610_11kHzMono', 'SpeechDiscardType',
    'DISPID_SPEEngineConfidence', 'DISPID_SBSSeek',
    'DISPID_SPPEngineConfidence', 'SPEI_START_SR_STREAM',
    'SGLexicalNoSpecialChars', 'SAFTDefault', 'DISPID_SGRSTType',
    'ISpeechPhraseReplacements', 'SpeechRegistryLocalMachineRoot',
    'eLEXTYPE_RESERVED4', 'DISPID_SRCEPhraseStart',
    'SPGRAMMARWORDTYPE', 'DISPID_SVAudioOutput',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SOTIsUISupported',
    'SpeechAudioFormatGUIDText', 'ISpStreamFormat',
    'DISPID_SPRNumberOfElements', 'SVPAlert', 'DISPID_SPRulesItem',
    '_ISpeechVoiceEvents', 'SAFT32kHz16BitStereo',
    'SWPKnownWordPronounceable', 'SECFIgnoreWidth', 'SPBO_AHEAD',
    'SECLowConfidence', 'SPWORDLIST', 'SP_VISEME_18',
    'DISPID_SpeechGrammarRuleState', 'SPVISEMES', 'ISpeechDataKey',
    'SVP_3', 'SGSExclusive', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SRState', 'SPEVENT', 'WAVEFORMATEX', 'SREBookmark',
    'DISPID_SRRTStreamTime', 'DISPID_SVSInputSentenceLength',
    'DISPID_SAFType', 'SAFT24kHz8BitMono', 'SPCATEGORYTYPE',
    'SPLO_DYNAMIC', 'DISPID_SVEAudioLevel',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SPERetainedStreamOffset',
    'SVP_11', 'DISPID_SpeechPhraseInfo', 'SpeechWordType',
    'SVEPhoneme', 'SpeechRunState', 'SpeechRecognizerState',
    'eLEXTYPE_PRIVATE9', 'ISequentialStream',
    'DISPID_SPANumberOfElementsInResult', 'ISpeechRecognizer',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SGRSTTWord',
    'eLEXTYPE_PRIVATE15', 'ISpeechPhraseAlternates',
    'eLEXTYPE_RESERVED6', 'SVEVoiceChange', 'SVP_17', 'SRESoundStart',
    'SPSTREAMFORMATTYPE', 'DISPID_SLWsItem', 'SPSHT_NotOverriden',
    'ISpMMSysAudio', 'SpeechPropertyNormalConfidenceThreshold',
    'SREStreamEnd', 'DISPID_SLWPronunciations',
    'DISPID_SABIBufferSize', 'SAFT22kHz16BitMono', 'DISPID_SRStatus',
    'SPRECOCONTEXTSTATUS', 'SpPhoneConverter', 'SPAUDIOOPTIONS',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SVDisplayUI',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SRGetPropertyString',
    ...
    'eLEXTYPE_PRIVATE17', 'SECFDefault', 'DISPID_SRCEAdaptation',
    'DISPID_SRRTimes', 'DISPID_SOTGetAttribute', 'SP_VISEME_15',
    'DISPID_SpeechWaveFormatEx', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SDKSetLongValue', 'SPEI_SENTENCE_BOUNDARY',
    'SpeechInterference', 'DISPID_SRGCommit', 'DISPID_SGRId',
    'SPSEMANTICERRORINFO', 'SPEI_SOUND_START', 'DISPID_SPEsCount',
    'DISPID_SASetState', 'ISpeechRecoResult', 'SPAUDIOSTATUS',
    'SP_VISEME_21', 'DISPID_SRSNumberOfActiveRules', 'SPPHRASERULE',
    'DISPID_SVSLastBookmarkId', 'SPPHRASEELEMENT', 'SPSVerb',
    'SPPS_Noncontent', 'SDKLCurrentConfig', 'SPEI_SR_BOOKMARK',
    'SPPS_NotOverriden', 'SRARoot', 'DISPID_SPPChildren',
    'SPCT_COMMAND', 'DISPID_SRGIsPronounceable', 'ISpRecoContext',
    'ISpEventSource', 'SpeechPropertyResourceUsage',
    'SAFT8kHz16BitMono', 'DISPID_SpeechLexiconWords',
    'SDA_No_Trailing_Space', 'DISPID_SOTGetStorageFileName',
    'DISPID_SpeechPhraseElement', 'DISPID_SPIAudioSizeTime',
    'DISPID_SpeechPhraseProperties', 'SPDKL_CurrentConfig',
    'SAFTCCITT_ALaw_22kHzMono', 'SWTDeleted', 'DISPID_SVEViseme',
    'SPWF_SRENGINE', 'SAFTCCITT_ALaw_8kHzStereo', 'SSTTTextBuffer',
    'SRCS_Disabled', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SGRInitialState', 'tagSPPROPERTYINFO',
    'SpeechCategoryPhoneConverters', 'ISpRecognizer2', 'SPRS_ACTIVE',
    'SpeechEngineConfidence', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SVWaitUntilDone', 'SP_VISEME_17', 'SRERequestUI',
    'DISPID_SRCEEnginePrivate', 'ISpeechPhraseElement',
    'DISPID_SAVolume', 'SAFTNonStandardFormat', 'SECNormalConfidence',
    'SPEI_RESERVED5', 'DISPID_SVEVoiceChange', 'SRTExtendableParse',
    'DISPID_SRRecognizer', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SpeechObjectTokenCategory', 'SVSFPurgeBeforeSpeak',
    'eLEXTYPE_APP', 'DISPID_SpeechVoiceEvent', 'SAFT11kHz8BitMono',
    'SRERecoOtherContext', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SPRuleChildren',
    'SVSFIsXML', 'SpeechCategoryAudioIn', 'DISPID_SLPSymbolic',
    'SAFTCCITT_uLaw_11kHzMono', 'SLTApp', 'ISpeechCustomStream',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SpeechLexicon', 'SVSFDefault',
    'Speech_StreamPos_Asap', 'SPEI_MAX_TTS', 'SPSModifier',
    'DISPID_SGRsAdd', 'DISPID_SpeechGrammarRules', 'SPEI_HYPOTHESIS',
    'DISPID_SRCEHypothesis', 'DISPID_SRCERequestUI',
    'ISpeechMMSysAudio', 'SSFMCreate', 'DISPID_SGRs_NewEnum',
    'SpeechVoiceSkipTypeSentence', 'SPTEXTSELECTIONINFO',
    'DISPID_SDKGetStringValue', 'DISPID_SpeechGrammarRule',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SpeechRecoContext',
    'eLEXTYPE_PRIVATE16', 'SITooSlow', 'SpeechSpecialTransitionType',
    'SAFT22kHz8BitStereo', 'ISpeechPhraseRules', 'SITooLoud',
    'DISPID_SRCEPropertyStringChange', 'SASStop',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SRRAlternates',
    'SAFT22kHz16BitStereo', 'DISPID_SLGenerationId', 'SPAS_STOP',
    'SpObjectToken', 'SINoSignal', 'SWTAdded',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SpeechWordPronounceable', 'Speech_Max_Pron_Length',
    '_ISpeechRecoContextEvents', 'SPSInterjection', 'DISPID_SBSRead',
    'SPBINARYGRAMMAR', 'DISPID_SPRuleName', 'DISPID_SPRuleConfidence',
    'DISPID_SRSClsidEngine', 'SAFT32kHz16BitMono',
    'SPINTERFERENCE_TOOSLOW', 'SLODynamic', 'SRTReSent',
    'SPEI_SOUND_END', 'DISPID_SPPId', 'SPINTERFERENCE_TOOLOUD',
    'SpPhraseInfoBuilder', 'IInternetSecurityMgrSite',
    'DISPID_SpeechMMSysAudio', 'STCAll', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SOTSetId', 'SAFTGSM610_44kHzMono',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SRCCmdMaxAlternates',
    'eLEXTYPE_RESERVED10', 'DISPID_SRCEStartStream',
    'DISPID_SGRSAddSpecialTransition', 'SpAudioFormat',
    'ISpeechObjectTokens', 'SPRECORESULTTIMES', 'SSFMCreateForWrite',
    'SSFMOpenForRead', 'SPEI_RESERVED6',
    'SpeechPropertyComplexResponseSpeed', 'SVP_2',
    'SpeechPartOfSpeech', 'DISPID_SVSyncronousSpeakTimeout',
    'SP_VISEME_10', 'DISPID_SRCState', 'SAFT8kHz16BitStereo',
    'SpNotifyTranslator', 'SPPS_RESERVED4', 'eLEXTYPE_PRIVATE4',
    'eLEXTYPE_PRIVATE12', 'SVP_1', 'SPWORDPRONUNCIATION', 'SVP_5',
    'SP_VISEME_9', 'ISpNotifyTranslator', 'SAFT11kHz16BitMono',
    'DISPID_SVSpeakStream', 'SVF_Emphasis', 'DISPID_SPRsItem',
    'STCInprocHandler', 'DISPID_SVEPhoneme', 'ISpRecoGrammar',
    'ISpeechWaveFormatEx', 'SPGS_ENABLED',
    'DISPID_SVSInputWordPosition', 'DISPID_SRGetRecognizers',
    'DISPID_SVSRunningState', 'DISPIDSPTSI', 'SSTTWildcard',
    'SAFTCCITT_uLaw_22kHzMono', 'ISpeechRecoResult2', 'DISPID_SVSkip',
    'SPLO_STATIC', 'SPPS_RESERVED3', 'SVP_19', 'SRTStandard',
    'SPRECOSTATE', 'SPAR_Medium', 'SAFT12kHz8BitMono',
    'ISpeechPhraseReplacement', 'eLEXTYPE_PRIVATE1', 'SPEI_MIN_TTS',
    'SAFTExtendedAudioFormat', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SPCIdToPhone', 'DISPID_SOTCGetDataKey',
    'DISPID_SPIGetText', 'DISPID_SpeechVoice',
    'DISPID_SLRemovePronunciation', 'SPRST_ACTIVE_ALWAYS',
    'eLEXTYPE_PRIVATE11', 'SpeechStreamFileMode', 'DISPID_SRProfile',
    'SP_VISEME_2', 'SPEI_TTS_PRIVATE', 'SPGRAMMARSTATE',
    'SPAUDIOBUFFERINFO', 'DISPID_SDKCreateKey', 'DISPID_SLGetWords',
    'SGSDisabled', 'ISpeechVoiceStatus', 'SREAdaptation',
    'SPEI_END_INPUT_STREAM', 'SPINTERFERENCE_NOSIGNAL',
    'SPCS_DISABLED', 'SPWF_INPUT', 'SpeechVoiceCategoryTTSRate',
    'SP_VISEME_19', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SASState', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SPEDisplayText', 'SPFILEMODE',
    'DISPID_SOTMatchesAttributes', 'eLEXTYPE_PRIVATE8',
    'DISPID_SLPsCount', 'SpCustomStream', 'SpeechMicTraining',
    'DISPID_SLGetGenerationChange', 'DISPID_SGRSTPropertyValue',
    'SVP_20', 'DISPID_SASCurrentSeekPosition', 'SAFT44kHz8BitMono',
    'SAFT12kHz8BitStereo', 'DISPID_SRRSetTextFeedback', 'SINoise',
    'IEnumString', 'ISpeechPhraseRule', 'ISpeechLexiconWords',
    'SPEVENTENUM', 'DISPID_SVAlertBoundary', 'DISPID_SVIsUISupported',
    'DISPID_SpeechAudioFormat', 'SpeechCategoryAppLexicons',
    'SRAONone', 'SPSEMANTICFORMAT', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SRSCurrentStreamNumber', 'SPSHORTCUTTYPE', 'SPFM_CREATE',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPVPRI_OVER', 'SPPS_Noun',
    'SAFT11kHz16BitStereo', 'ISpeechRecognizerStatus',
    'SGPronounciation', 'SPBOOKMARKOPTIONS', 'SPPS_RESERVED1',
    'SVEAudioLevel', 'SREAudioLevel', 'DISPID_SLPPartOfSpeech',
    'SpeechTokenKeyUI', 'ISpRecoResult', 'SAFTADPCM_44kHzMono',
    'SDKLCurrentUser', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPEI_TTS_BOOKMARK', 'SDTAudio', 'SREFalseRecognition',
    'ISpeechAudioStatus', 'DISPID_SRCEAudioLevel', 'SDTAll',
    'SpeechDataKeyLocation', 'SVEWordBoundary', 'DISPID_SGRSTsItem',
    'SPCT_SLEEP', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SpeechPhraseAlternates', 'SAFT44kHz16BitStereo',
    'ISpeechResourceLoader', 'DISPID_SVAudioOutputStream',
    'DISPID_SPIGrammarId', 'DISPID_SVSLastResult',
    ...
    'SpeechTokenKeyAttributes', 'SPVOICESTATUS',
    'SpeechAddRemoveWord', 'SVP_16', 'SPSHT_Unknown',
    'DISPID_SRGSetTextSelection'
]

_check_version('1.2.1', 1700803699.612701)
